...
Updated on 2026-04-25 after landing risky-delta promotion policy inside the Phase 5 promote path.
...
5. continue Phase 5 by hardening the layer above the landed distill/propose/promote/update surfaces:
   ...
   - live-smoke source-output distillation, proposal, risky-delta rejection, and accepted promotion through the app-server seam
   - only after that, add the next smallest promotion/proposal rule the smoke exposes
