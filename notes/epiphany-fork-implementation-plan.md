...
- the richer app-server smoke now asserts direct update publishes source/revision/changed-fields `update`/`1`/`observations,evidence` and accepted promotion publishes source/revision/changed-fields `promote`/`2`/`graphs,graphFrontier,observations,evidence,churn`
