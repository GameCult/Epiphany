...
a Soul verdict, rerun, state commit, publication, or Hands authority. Its
receipt
includes
...
`repo-verification-request`, a `safeActionFamily`, and an authority seal
