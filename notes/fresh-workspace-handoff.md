...
receipt expectations, and acceptance now has persisted Mind review/commit proof,
but most non-Mind gates still need runtime enforcement that proves the required
receipts before state/action promotion. Do not blindly require the whole organ
catalog for every result; split required receipts by effect type and then make
those proof profiles executable. The
