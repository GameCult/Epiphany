...
acceptance bundle policy/tests, and reorientation resume/regather verdict policy/tests live in core, live acceptance writes typed receipts keyed by runtime result id,
