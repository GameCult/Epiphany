...
- Wrapper `swarm-overview` and `swarm-triage` one-line summaries now include service lifecycle receipt `artifactStatus`, local runbook `sha256`, operator aftercare, and compact `serviceExecutionFailedChecks`. Failed checks now include `artifact=<operatorArtifactRef>` and `sha256=<digest-or-none>`, hashing local file artifacts while leaving service-manager refs as `sha256=none`. Live artifacts `local-20260618-171123-940-2eebc347` and `local-20260618-171124-038-6688a1e1` show both lifecycle attention rows, the operator-elevated runbook row with `sha256=3239ac17008b1ce857970e40b17d37a1ecf1631a3a6636bb2b8678312fb604a0`, `aftercare=tools/epiphany_local_run.ps1 -Mode cluster-service-execution-audit`, service-manager refs for readiness/start/audit/stop, and the historical install script artifact hashed as `c6b697e173eb319073da341fc90c2963bcd6bee63d804349205b6309c88df764`, with private state sealed.
