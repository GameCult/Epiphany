...
- Next real product move: import GitHub Issues into planning captures so real external backlog material can feed Imagination before returning to EpiphanyGraph/Rider bridge work.
