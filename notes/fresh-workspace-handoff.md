...
- 2026-06-19: The daemon tool directory now advertises Self `swarm-online-runbook` beside Self `service-health` as globally available, receipt-gated, private-state-sealed CultMesh capabilities over the daemon service lifecycle contract. Source smoke reports `daemonTools=18`, and live wrapper proof `local-20260619-032243-566-545b148c` printed `READY | Self | swarm-online-runbook | prepareSwarmOnlineRunbook | epiphany.cluster.self.tool.swarm-online-runbook | eve://epiphany/self | authority=daemon.service_lifecycle | input=epiphany.cultmesh.daemon_service_online_runbook_request | receiptType=epiphany.cultmesh.daemon_service_lifecycle_receipt | allAgents=true | receipt=true | private=false`.
