...
- Receipt directory rows now classify and hash their artifact refs. `ReceiptDirectoryRow` includes `artifactStatus` plus `artifactSha256`, and receipt TUI rows append `artifact=<status> | sha256=<digest-or-none>`. Fresh smoke now guards present-artifact SHA-256 in receipt-directory JSON/TUI, and live wrapper artifact `local-20260618-165005-139-6188fe30` proves the cluster execution runbook row reports `artifactSha256=3239ac17008b1ce857970e40b17d37a1ecf1631a3a6636bb2b8678312fb604a0`, the per-service execution runbook row reports `artifactSha256=b213a3c11a8f11a03061fcd743f507edaa59bc6767257b79cef63329596375e7`, and non-artifact rows report `artifactSha256=none`.
