...
Objective: make Hands the action organ. Commands, patches, commits, and
...
- Outputs: Hands action reviews, command receipts, patch receipts, commit
  receipts, rollback receipts, and action refusal receipts.
- Derived state: diffs, command logs, commits, and rollback notes are
...
- Forbidden writers: raw workers, Persona, Eyes, Imagination, Self, compatibility
  ...
  access.
- Shared path: file edits, shell commands, commits, and rollbacks should
