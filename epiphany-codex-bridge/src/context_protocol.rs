...
pub fn protocol_context_view(
    ...
    (
        protocol_context_state_status(view.state_status),
        view.state_revision,
        protocol_context(view.context),
        protocol_context_missing(view.missing),
    )
}

pub fn protocol_context_state_status(
...
fn protocol_context(context: CoreEpiphanyContext) -> ThreadEpiphanyContext {
    ThreadEpiphanyContext {
        graph: protocol_graph_context(context.graph),
...
pub fn protocol_graph_context(graph: CoreEpiphanyGraphContext) -> ThreadEpiphanyGraphContext {
...
fn protocol_context_missing(missing: CoreEpiphanyContextMissing) -> ThreadEpiphanyContextMissing {
    ThreadEpiphanyContextMissing {
...
pub fn protocol_planning_view(
    ...
    (
        ...
        view.state_revision,
        view.planning,
        protocol_planning_summary(view.summary),
    )
}

fn protocol_planning_summary(
...
pub fn protocol_graph_query_view(
    ...
    (
        protocol_context_state_status(view.state_status),
        view.state_revision,
        protocol_graph_context(view.graph),
        view.frontier,
        view.checkpoint,
        protocol_graph_query_matched(view.matched),
        protocol_graph_query_missing(view.missing),
    )
}

fn protocol_graph_query_matched(
...
fn protocol_graph_query_missing(
