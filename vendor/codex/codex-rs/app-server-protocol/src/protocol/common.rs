    ...
    fn thread_epiphany_job_launch_is_marked_experimental() {
        let request = ClientRequest::ThreadEpiphanyJobLaunch {
            ...
            params: v2::ThreadEpiphanyJobLaunchParams {
                ...
                launch_document: v2::ThreadEpiphanyWorkerLaunchDocument::Role(
                    v2::ThreadEpiphanyRoleWorkerLaunchDocument {
                        thread_id: "thr_123".to_string(),
                ...
                output_contract_id: "epiphany.role_worker_result.v0".to_string(),
