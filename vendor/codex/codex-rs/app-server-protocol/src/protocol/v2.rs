...
use epiphany_state_model::EpiphanyAcceptanceReceipt as CoreEpiphanyAcceptanceReceipt;
use epiphany_state_model::EpiphanyChurnState as CoreEpiphanyChurnState;
use epiphany_state_model::EpiphanyCodeRef as CoreEpiphanyCodeRef;
use epiphany_state_model::EpiphanyEvidenceRecord as CoreEpiphanyEvidenceRecord;
use epiphany_state_model::EpiphanyGraphCheckpoint as CoreEpiphanyGraphCheckpoint;
use epiphany_state_model::EpiphanyGraphEdge as CoreEpiphanyGraphEdge;
use epiphany_state_model::EpiphanyGraphFrontier as CoreEpiphanyGraphFrontier;
use epiphany_state_model::EpiphanyGraphLink as CoreEpiphanyGraphLink;
use epiphany_state_model::EpiphanyGraphNode as CoreEpiphanyGraphNode;
use epiphany_state_model::EpiphanyGraphs as CoreEpiphanyGraphs;
use epiphany_state_model::EpiphanyInvariant as CoreEpiphanyInvariant;
use epiphany_state_model::EpiphanyInvestigationCheckpoint as CoreEpiphanyInvestigationCheckpoint;
use epiphany_state_model::EpiphanyInvestigationDisposition as CoreEpiphanyInvestigationDisposition;
use epiphany_state_model::EpiphanyJobBinding as CoreEpiphanyJobBinding;
use epiphany_state_model::EpiphanyJobKind as CoreEpiphanyJobKind;
use epiphany_state_model::EpiphanyModeState as CoreEpiphanyModeState;
use epiphany_state_model::EpiphanyObservation as CoreEpiphanyObservation;
use epiphany_state_model::EpiphanyPlanningState as CoreEpiphanyPlanningState;
use epiphany_state_model::EpiphanyRetrievalStatus as CoreEpiphanyRetrievalStatus;
use epiphany_state_model::EpiphanyRuntimeLink as CoreEpiphanyRuntimeLink;
use epiphany_state_model::EpiphanyScratchPad as CoreEpiphanyScratchPad;
use epiphany_state_model::EpiphanySubgoal as CoreEpiphanySubgoal;
use epiphany_state_model::EpiphanyThreadState as CoreEpiphanyThreadState;
...
pub struct ThreadEpiphanyCoordinatorSignals {
    ...
    pub research_result_status: ThreadEpiphanyRoleResultStatus,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyFreshnessParams {
    pub thread_id: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyFreshnessResponse {
    pub thread_id: String,
    pub source: ThreadEpiphanyFreshnessSource,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
    pub state_revision: Option<u64>,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyFreshnessSource {
    Stored,
    Live,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyRetrievalFreshnessStatus {
    Missing,
    Ready,
    Stale,
    Indexing,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyRetrievalFreshness {
    pub status: ThreadEpiphanyRetrievalFreshnessStatus,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyGraphFreshnessStatus {
    Missing,
    Ready,
    Stale,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyGraphFreshness {
    pub status: ThreadEpiphanyGraphFreshnessStatus,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
    pub graph_freshness: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyJobKind {
    Indexing,
    Remap,
    Verification,
    Specialist,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyJob {
    pub id: String,
    pub kind: ThreadEpiphanyJobKind,
    pub scope: String,
    pub owner_role: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyReorientResultParams {
    pub thread_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
    pub binding_id: Option<String>,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyReorientResultResponse {
    pub thread_id: String,
    pub source: ThreadEpiphanyReorientSource,
    pub state_status: ThreadEpiphanyReorientStateStatus,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub state_revision: Option<u64>,
    pub binding_id: String,
    pub status: ThreadEpiphanyReorientResultStatus,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
    pub job: Option<ThreadEpiphanyJob>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
    pub finding: Option<ThreadEpiphanyReorientFinding>,
    pub note: String,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyReorientResultStatus {
    MissingState,
    MissingBinding,
    BackendUnavailable,
    BackendMissing,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadEpiphanyReorientFinding {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional = nullable)]
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum ThreadEpiphanyStateUpdatedField {
    Objective,
    ActiveSubgoalId,
    Subgoals,
    Invariants,
...
pub struct Thread {
    ...
    /// Only populated on `thread/start`, `thread/resume`, `thread/fork`, `thread/read`,
    /// and notifications/responses that reuse those hydrated thread payloads.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
    pub epiphany_state: Option<CoreEpiphanyThreadState>,
