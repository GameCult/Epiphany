...
pub use workspace_coverage_process_documents::{
    ...
    load_workspace_coverage_provider_heartbeat, observe_workspace_coverage_managed_process,
    process_identity_from_workspace_coverage_launch, sign_workspace_coverage_heartbeat,
    sign_workspace_coverage_launch, sign_workspace_coverage_termination,
    workspace_coverage_heartbeat_statement, workspace_coverage_host_identity_record_digest,
    workspace_coverage_launch_statement, workspace_coverage_termination_statement,
