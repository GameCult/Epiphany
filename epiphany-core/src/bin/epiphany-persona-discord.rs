...
fn run_smoke() -> Result<Value> {
    ...
    let draft = run_draft(
        "Persona notices Proprioception and Soul disagree about evidence shape.",
        &config,
        &temp_dir,
        "draft",
        "drafted without posting",
