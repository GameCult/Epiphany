...
fn run_cli() -> Result<()> {
    ...
    match args.command.as_str() {
        ...
        "smoke" => {
            ...
            if !WRAPPER_RECEIPT_DIRECTORY_COMMAND.contains("-Mode receipt-directory")
